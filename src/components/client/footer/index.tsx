...
import '../../../assets/images/methods.png'

const Footer = () => {
  const method_img = '../../../src/assets/images/methods.png'
  return (
    <>
   {/* footer  */}
  ...
  <div className="container grid grid-cols-1 ">
    <div className="col-span-1 space-y-4">
      <img src="https://img.icons8.com/cotton/64/fast-food--v2.png" width='36' height='36' alt="logo" className="w-30" />
      <div className="mr-2">
...
<div className="bg-gray-800 py-4">
  <div className="container flex items-center justify-between">
    ...
    <div>
      <img src={method_img} alt="methods" className="h-5" />
    </div>
  </div>
</div>
    {/* end footer  */}
